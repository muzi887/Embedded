...
> **相关文档**
>
> - [文件说明.md](./文件说明.md) — 本目录索引
> - [梯控固件项目介绍.md](./梯控固件项目介绍.md) — 黑名单 / 密钥在系统中的位置
> - [梯控固件入门规划-基于F103基础.md](./梯控固件入门规划-基于F103基础.md) — 阶段 E：存储与联调
> - [FUNCTION_SUMMARY.md](./FUNCTION_SUMMARY.md) — 黑名单与存储模块摘要
...
驱动是 **GPIO 软件模拟 I2C**（`HARDWARE/iic.c`），不是硬件 `I2C1/I2C2`。时序概念与 [STM32-I2C说明.md](../../../docs/STM32-I2C说明.md) 相同。
