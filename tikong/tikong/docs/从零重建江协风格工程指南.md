...
> [Keil-New-Project只拷代码指南.md](./Keil-New-Project只拷代码指南.md)（本文作拷贝总表与目录说明）。

> 目标树与业务拆分仍以 [目录问题与重构方案.md](./目录问题与重构方案.md) 为准。  
...
4. 建议：拷贝前把本指南与 [目录问题与重构方案.md](./目录问题与重构方案.md) 打开放在旁边对照。
...
→ **[Keil-New-Project只拷代码指南.md](./Keil-New-Project只拷代码指南.md)**
...
| 文档                                                                       | 用途                     |
| ------------------------------------------------------------------------ | ---------------------- |
| [目录问题与重构方案.md](./目录问题与重构方案.md)                                           | 问题 + 目标树（两种实施都适用）      |
