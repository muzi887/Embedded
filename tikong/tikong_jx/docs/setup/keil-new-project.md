...
更新时间：2026-07-17  
前提：目标目录树见 [从零重建江协风格工程指南.md](./rebuild-jiangxie.md)  
...
按 [从零重建江协风格工程指南.md](./rebuild-jiangxie.md) **§五** 整表拷；最少要有：
...
| [从零重建江协风格工程指南.md](./rebuild-jiangxie.md) | 拷贝对照总表、目录含义、验收标准 |
| [目录问题与重构方案.md](./dir-refactor-plan.md) | 为什么要这样拆 |
